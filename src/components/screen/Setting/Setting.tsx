...
const SETTING_LIST_DATA = [
  {
    ...
    leftText: 'テーマ',
    leftComponent: <SparklesIcon icon="icon1" />,
  ...
  },
  {
    ...
    leftText: 'プライバシーポリシー',
    leftComponent: <LockClosedIcon icon="icon1" />,
    rightComponent: <ChevronRightIcon />,
    onPress: null,
  },
  {
    ...
    leftText: '利用規約',
    leftComponent: <ShieldCheckIcon icon="icon1" />,
    rightComponent: <ChevronRightIcon />,
    onPress: null,
  },
  {
    ...
    leftText: 'お問い合わせ',
    leftComponent: <MailIcon icon="icon1" />,
    rightComponent: <ChevronRightIcon />,
    onPress: null,
  },
  {
    ...
    navigate: undefined,
    leftText: 'アプリバージョン',
    leftComponent: <ColorSwatchIcon icon="icon1" />,
    rightText: '1.0.0',
    isDivider: true,
    onPress: null,
  },
