...
const ToastBar = memo(
  ({ toast, updateHeight, offset, options: _options, position: _position, ..._props }: any) => {
...
export const Toaster: FC<any> = memo(
  ({ position = 'top-center', containerStyle, toastOptions }) => {
